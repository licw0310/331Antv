  ...
  <div class="container_warp">
    ...
    <div class="operating">
      <div class="btn-group">
        ...
        <div class="btn" title="水平泳道">
          <img
            data-v-6a1722a2=""
            src="https://lzos-pre.rysaas.cn/levault-se/bpmsvr/x6NodeRowLane.svg"
            @mousedown="startDrag('lane-x', $event)"
            class="left-node"
            style="width:100%"
          />
        </div>
        <div class="btn" title="垂直道">
          <img
            data-v-6a1722a2=""
            src="https://lzos-pre.rysaas.cn/levault-se/bpmsvr/x6NodeColLane.svg"
            @mousedown="startDrag('lane-y', $event)"
            class="left-node"
            style="height:100%"
          />
        </div>
    ...
    initX6() {
      ...
      this.graph.on("selection:changed", args => {
        args.added.forEach(cell => {
          console.log("cell--", cell.store.data.shape);
